...
class DataValidator:
    ...
    def check_nulls(self) -> "DataValidator":
        ...
        NULL values are dangerous because:
          - salary.mean() on a column with NaN returns NaN
        ...
        - Optional form fields: an employee record where "middle_name" was not filled.
        - System migrations: data that was never collected in the old system.
    ...
    def check_numeric_ranges(self) -> "DataValidator":
        ...
        DELTA_COLUMNS = {
            ...
            "vs_customer_avg", "price_vs_market_avg",
        }
